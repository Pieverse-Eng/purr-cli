...
Examples:
  ...
  purr binance-onchain-pay pre-order --idempotency-key checkout-123 --merchant-code <code> --merchant-name <name> --fiat USD --crypto USDT --requested-amount 50 --amount-type 1 --network BSC --address 0x...
