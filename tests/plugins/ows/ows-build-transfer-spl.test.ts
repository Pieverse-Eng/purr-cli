 ...
 * impl (build-transfer.ts) surfaces as a test failure.
 */

import { PublicKey } from '@solana/web3.js'
import { describe, expect, it } from 'vitest'

const mod = (await import('@pieverseio/purr-plugin-ows/build-transfer')) as unknown as Record<
  string,
  unknown
>
...
describe('module loads', () => {
  it('build-transfer.ts exposes owsBuildTransfer', () => {
